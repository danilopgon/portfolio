...
const HeroImage = ({ image, alt, imageMobile }: HeroImageProps): JSX.Element => {
  return (
    <ParallaxBanner className="flex min-h-[70vh] w-full md:h-screen xl:h-[90vh]">
      <ParallaxBannerLayer speed={0.5} scale={[1.2, 1]} className="object-top">
        <img src={image} alt={alt} className="hidden h-full w-full animate-fade object-cover object-top xl:flex" />
      </ParallaxBannerLayer>
