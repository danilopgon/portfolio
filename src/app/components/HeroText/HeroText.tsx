    ...
    <header className="w-full">
      <div className="justify-left my-5 flex h-2/3 w-full px-6 py-8 uppercase text-default-800 md:justify-between md:px-12 md:pt-14 xl:px-20 xl:pt-24">
        <div className="flex flex-col gap-4 ">
          <h1 className="hover:duration-50 transform  animate-fade-right text-left text-2xl font-bold transition duration-100 animate-normal animate-fill-both  animate-once animate-ease-in-out hover:-translate-y-1 hover:animate-fade-left hover:ease-in-out md:text-4xl lg:text-6xl 2xl:text-8xl">
