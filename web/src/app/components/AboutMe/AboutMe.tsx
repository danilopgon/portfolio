  ...
  return (
    <section role="section" className=" flex h-2/3 w-full flex-col text-default-800 ">
      ...
      <div className="flex w-full flex-col-reverse items-center justify-evenly p-6 md:h-64 md:flex-row md:p-12 lg:h-96 xl:my-5 xl:p-20 ">
        ...
        />
        <div className="mt-5  flex h-full w-full flex-col  justify-evenly  md:w-4/12">
          <h2 className="animate-fade-down text-xl md:animate-fade-left md:px-3 lg:text-2xl xl:text-3xl 2xl:text-4xl">
            // Sobre mí
          </h2>

          <div className="mt-10 flex animate-fade-down gap-3 md:animate-fade-left md:px-3">
            <Button
            ...
            >
              <svg
                ...
                height="100"
                viewBox="0 0 24 24"
                className="h-7 fill-primary-foreground"
              >
